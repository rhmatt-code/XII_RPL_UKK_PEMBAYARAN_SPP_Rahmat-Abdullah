                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 text-left flex">
                            <a href="#" data-modal-target='edit-class{{$data->id_kelas}}' data-modal-toggle="edit-class{{$data->id_kelas}}" data-nama="{{$data->nama_kelas}}" data-jurusan="{{$data->kompetensi_keahlian}}" class="editclass text-red-600 dark:text-blue-500 hover:text-red-900">
...
{{-- Modal Add Class --}}
<div id="add-class" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
