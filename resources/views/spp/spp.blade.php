                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 text-left flex">
                            <a href="#" data-modal-target='edit-class{{$data->id_kelas}}' data-modal-toggle="edit-class{{$data->id_kelas}}" class="editclass text-red-600 dark:text-blue-500 hover:text-red-900">
