...
{{-- Modal Add SPP --}}
<div id="add-petugas" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full uk-animation-fade uk-animation-fast">
