      ...
      <ul class="pt-4 mt-2 space-y-2 ">
         ...
         @if (request()->routeIs('siswa'))
            <a class="flex items-center border-2 border-gray-200 shadow-sm p-2 m-2 text-base font-normal text-gray-900 rounded-lg dark:text-white bg-gray-200">
               <svg class="flex-shrink-0 w-6 h-6  transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
